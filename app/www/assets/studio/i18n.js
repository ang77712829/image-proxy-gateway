...
const zhCN = {
  ...
  'providers.subtitle': '只读显示自定义服务商配置摘要。不会测试连接，也不会刷新服务商状态。',
...
const enUS = {
  ...
  'providers.subtitle': 'Read-only summary of custom provider configuration. No connection tests or live status checks are performed.',
